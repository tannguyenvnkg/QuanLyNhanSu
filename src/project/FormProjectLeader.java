 ...
 * @author Admin
 */
public class FormProjectLeader extends javax.swing.JFrame {

    /**
     * Creates new form FormDuAn
     */
    public FormProjectLeader() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Dự Án", "Tên Dự Án", "Thời Gian Bắt Đầu", "Thời Gian Kết Thúc", "Trạng Thái", "Phòng"
            }
        ) {
            boolean[] canEdit = new boolean [] {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormProjectLeader.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormProjectLeader().setVisible(true);
            }
        });
    }
